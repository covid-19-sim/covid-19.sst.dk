...
XPATH_ZIP_URL =     "//*[@id='top']/div[2]/section[6]/blockquote/div/strong/a[contains(@title,'Data epidemiologisk rapport fra') and contains(text(),'fil med overvågningsdata')]/@href"
